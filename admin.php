											...
											<?php if ( $subscription->status == 'Active' ) : ?>
												...
												<?php if ( $subscription->paypal_subscription_id ) : ?>
													<div class="displayinlineblock" data-toggle="tooltip" data-title="PayPal subscriptions can only be canceled directly through your PayPal account.">
														<a href="#" class="btn btn-sm btn-default confirm-click disabled"><fa class="fa fa-times colorwarning"></fa> Cancel</a>
													</div>
												<?php else : ?>
													<a href="<?php echo url('process.php?action=cancel_subscription&subscription_id=' . $subscription->id . '&return=admin'); ?>" class="btn btn-sm btn-default confirm-click" data-text="Yes, cancel it!"><fa class="fa fa-times colorwarning"></fa> Cancel</a>
												<?php endif; ?>
